...
def sky130_fd_pr__res_generic_po(
    ...
    nc_licon = max(1, 1 + floor((avail_licon - 0.17) / 0.34)) if avail_licon >= 0.17 else 1
    ...
    _rect(c, LAYER.li1drawing, -li_strip_hw, li_strip_bot, li_strip_hw, li_strip_top)     # top
    _rect(c, LAYER.li1drawing, -li_strip_hw, -li_strip_top, li_strip_hw, -li_strip_bot)  # bottom
...
def sky130_fd_pr__res_high_po_0p35(
    ...
    rpm_enc = 0.200
    _rect(c, LAYER.rpmdrawing, -hw - rpm_enc, -poly_half - rpm_enc,
          hw + rpm_enc, poly_half + rpm_enc)
    ...
    npc_enc = 0.095
    _rect(c, LAYER.npcdrawing, -hw - npc_enc, -poly_half - npc_enc,
          hw + npc_enc, poly_half + npc_enc)
    ...
    # Top head
    _rect(c, LAYER.licon1drawing, -licon_strip_hw, licon_strip_bot,
          licon_strip_hw, licon_strip_top)
    # Bottom head
    _rect(c, LAYER.licon1drawing, -licon_strip_hw, -licon_strip_top,
          licon_strip_hw, -licon_strip_bot)
...
def sky130_fd_pr__res_generic_nd(
    ...
    nsdm_enc = 0.125
    _rect(c, LAYER.nsdmdrawing, -hw - nsdm_enc, -diff_half - nsdm_enc,
          hw + nsdm_enc, diff_half + nsdm_enc)
    ...
    _rect(c, LAYER.li1drawing, -li_cap_hw, -licon_top, li_cap_hw, -licon_bot)    # bottom cap

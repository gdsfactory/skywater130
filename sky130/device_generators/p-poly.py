...
def p_n_poly ( 
    ...
    for i in range(2):
        ...
        li_m1 = c.add_array(rect_li_m1, rows=2 , columns= 1 , spacing= (0, p_poly_length + 2* contact_enclosure[1] + licon_slots_size[1] - (1-i)*(mcon_enclosure[1]-li_enclosure)))
        li_m1.movey(- licon_slots_size[1] - contact_enclosure[1] - i*li_enclosure - (1-i)*mcon_enclosure[1])
    ...
    for i in range(2):
        ...
        mcon_arr.movex((rect_li_m1.xmax - rect_li_m1.xmin - nc_m*contact_size[0] - (nc_m-1)*contact_spacing[0])/2)
        mcon_arr.movey((rect_li_m1.ymax - rect_li_m1.ymin - nr_m*contact_size[1] - (nr_m-1)*contact_spacing[1])/2)
